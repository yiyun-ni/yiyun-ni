const socials = [
  {
    label: 'Email',
    href: 'mailto:crystal.yiyun.ni@gmail.com',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/yiyun-crystal-ni/',
    icon: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/yiyun-ni',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default function Contact() {
  return (
    <section
      id="contact"
      className="max-w-[1300px] mx-auto px-6 sm:px-8 lg:px-10 scroll-mt-[68px]"
    >
          ...
          <div className="flex gap-3">
            {socials.map(({ label, href, icon }) => (
              <a
                ...
                aria-label={label}
                className="w-[45px] h-[45px] grid place-items-center border border-border hover:text-accent hover:border-accent hover:-translate-y-1 transition-all duration-200"
              >
                {icon}
              </a>
            ))}
